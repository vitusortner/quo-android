 ...
 */
class PlacePreviewAdapter(private val context: Context, private val list: List<PlacePreview>) :
    ...
    class PlacePreviewViewHolder(private val context: Context, override val containerView: View) :
